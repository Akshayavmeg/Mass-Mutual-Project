...
| `routing_number`    | VARCHAR(20)   | NULL         | Extracted routing/transit number |
...
| `routing_number_valid` | BOOLEAN     | NOT NULL    | Routing validation        |
...
# 18. `audit_events` Table

Stores the complete audit history of the system.

| Column              | Data Type   | Constraints | Description        |
| ------------------- | ----------- | ----------- | ------------------ |
| `audit_id`          | UUID        | PK          | Unique audit event |
| `cheque_id`         | UUID        | FK          | Related cheque     |
| `user_id`           | UUID        | FK, NULL    | User responsible   |
...
| `audit_events`        | `cheque_id`            | `cheques.cheque_id`        |
| `audit_events`        | `user_id`              | `users.user_id`            |
